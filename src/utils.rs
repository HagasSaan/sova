...
pub unsafe fn from_arr_ptr_to_vec(c_array_pointer: *const *const c_char) -> Option<Vec<String>> {
    ...
    let rust_vec = slice::from_raw_parts(c_array_pointer, array_size).to_vec();
